...
void mkl_scsrbsr(MKL_INT * job,MKL_INT * m,MKL_INT * mblk,MKL_INT * ldAbsr,float *Acsr,MKL_INT * AJ,MKL_INT * AI,float *Absr, MKL_INT * AJB, MKL_INT * AIB, MKL_INT * info);
void mkl_scsrcoo(MKL_INT * job,MKL_INT * n,float *Acsr,MKL_INT * AJR,MKL_INT * AIR,MKL_INT * nnz,float *Acoo, MKL_INT * ir, MKL_INT * jc, MKL_INT * info);
void mkl_sdnscsr(MKL_INT *job,MKL_INT *m,MKL_INT *n,float *Adns,MKL_INT *lda,float *Acsr,MKL_INT *AJ,MKL_INT *AI,MKL_INT *info);
void mkl_scsrcsc(MKL_INT * job,MKL_INT * n,float *Acsr,MKL_INT * AJ0,MKL_INT * AI0,float *Acsc,MKL_INT * AJ1,MKL_INT * AI1,MKL_INT * info);
void mkl_scsrdia(MKL_INT * job,MKL_INT * n,float *Acsr,MKL_INT * AJ0,MKL_INT * AI0,float *Adia,MKL_INT * ndiag,MKL_INT * distance,MKL_INT * idiag,float *Acsr_rem,MKL_INT * AJ0_rem,MKL_INT * AI0_rem,MKL_INT * info);
void mkl_scsrsky(MKL_INT * job,MKL_INT * n,float *Acsr,MKL_INT * AJ0,MKL_INT * AI0, float *Asky,MKL_INT * pointers,MKL_INT * info);

void mkl_ccsrbsr(MKL_INT * job,MKL_INT * m,MKL_INT * mblk,MKL_INT * ldAbsr,MKL_Complex8 *Acsr,MKL_INT * AJ,MKL_INT * AI,MKL_Complex8 *Absr, MKL_INT * AJB, MKL_INT * AIB, MKL_INT * info);
void mkl_ccsrcoo(MKL_INT * job,MKL_INT * n,MKL_Complex8 *Acsr,MKL_INT * AJR,MKL_INT * AIR,MKL_INT * nnz,MKL_Complex8 *Acoo, MKL_INT * ir, MKL_INT * jc, MKL_INT * info);
void mkl_cdnscsr(MKL_INT *job,MKL_INT *m,MKL_INT *n,MKL_Complex8 *Adns,MKL_INT *lda,MKL_Complex8 *Acsr,MKL_INT *AJ,MKL_INT *AI,MKL_INT *info);
void mkl_ccsrcsc(MKL_INT * job,MKL_INT * n,MKL_Complex8 *Acsr,MKL_INT * AJ0,MKL_INT * AI0,MKL_Complex8 *Acsc,MKL_INT * AJ1,MKL_INT * AI1,MKL_INT * info);
void mkl_ccsrdia(MKL_INT * job,MKL_INT * n,MKL_Complex8 *Acsr,MKL_INT * AJ0,MKL_INT * AI0,MKL_Complex8 *Adia,MKL_INT * ndiag,MKL_INT * distance,MKL_INT * idiag,MKL_Complex8 *Acsr_rem,MKL_INT * AJ0_rem,MKL_INT * AI0_rem,MKL_INT * info);
void mkl_ccsrsky(MKL_INT * job,MKL_INT * n,MKL_Complex8 *Acsr,MKL_INT * AJ0,MKL_INT * AI0, MKL_Complex8 *Asky,MKL_INT * pointers,MKL_INT * info);

void mkl_zcsrbsr(MKL_INT * job,MKL_INT * m,MKL_INT * mblk,MKL_INT * ldAbsr,MKL_Complex16 *Acsr,MKL_INT * AJ,MKL_INT * AI,MKL_Complex16 *Absr, MKL_INT * AJB, MKL_INT * AIB, MKL_INT * info);
void mkl_zcsrcoo(MKL_INT * job,MKL_INT * n,MKL_Complex16 *Acsr,MKL_INT * AJR,MKL_INT * AIR,MKL_INT * nnz,MKL_Complex16 *Acoo, MKL_INT * ir, MKL_INT * jc, MKL_INT * info);
void mkl_zdnscsr(MKL_INT *job,MKL_INT *m,MKL_INT *n,MKL_Complex16 *Adns,MKL_INT *lda,MKL_Complex16 *Acsr,MKL_INT *AJ,MKL_INT *AI,MKL_INT *info);
void mkl_zcsrcsc(MKL_INT * job,MKL_INT * n,MKL_Complex16 *Acsr,MKL_INT * AJ0,MKL_INT * AI0,MKL_Complex16 *Acsc,MKL_INT * AJ1,MKL_INT * AI1,MKL_INT * info);
void mkl_zcsrdia(MKL_INT * job,MKL_INT * n,MKL_Complex16 *Acsr,MKL_INT * AJ0,MKL_INT * AI0,MKL_Complex16 *Adia,MKL_INT * ndiag,MKL_INT * distance,MKL_INT * idiag,MKL_Complex16 *Acsr_rem,MKL_INT * AJ0_rem,MKL_INT * AI0_rem,MKL_INT * info);
void mkl_zcsrsky(MKL_INT * job,MKL_INT * n,MKL_Complex16 *Acsr,MKL_INT * AJ0,MKL_INT * AI0, MKL_Complex16 *Asky,MKL_INT * pointers,MKL_INT * info);
...
void mkl_dcsrmultd(char *transa,  MKL_INT *m, MKL_INT *n, MKL_INT *k, double *a, MKL_INT *ja, MKL_INT *ia, double *b, MKL_INT *jb, MKL_INT *ib, double *c, MKL_INT *ldc);
void mkl_dcsradd(char *transa, MKL_INT *job, MKL_INT *sort, MKL_INT *m, MKL_INT *n, double *a, MKL_INT *ja, MKL_INT *ia, double *beta, double *b, MKL_INT *jb, MKL_INT *ib, double *c, MKL_INT *jc, MKL_INT *ic, MKL_INT *nnzmax, MKL_INT *ierr);

void mkl_scsrmultcsr(char *transa, MKL_INT *job, MKL_INT *sort, MKL_INT *m, MKL_INT *n, MKL_INT *k, float *a, MKL_INT *ja, MKL_INT *ia, float *b, MKL_INT *jb, MKL_INT *ib, float *c, MKL_INT *jc, MKL_INT *ic, MKL_INT *nnzmax, MKL_INT *ierr);
...
void mkl_scsradd(char *transa, MKL_INT *job, MKL_INT *sort, MKL_INT *m, MKL_INT *n, float *a, MKL_INT *ja, MKL_INT *ia, float *beta, float *b, MKL_INT *jb, MKL_INT *ib, float *c, MKL_INT *jc, MKL_INT *ic, MKL_INT *nnzmax, MKL_INT *ierr);

void mkl_ccsrmultcsr(char *transa, MKL_INT *job, MKL_INT *sort, MKL_INT *m, MKL_INT *n, MKL_INT *k, MKL_Complex8 *a, MKL_INT *ja, MKL_INT *ia, MKL_Complex8 *b, MKL_INT *jb, MKL_INT *ib, MKL_Complex8 *c, MKL_INT *jc, MKL_INT *ic, MKL_INT *nnzmax, MKL_INT *ierr);
void mkl_ccsrmultd(char *transa,  MKL_INT *m, MKL_INT *n, MKL_INT *k, MKL_Complex8 *a, MKL_INT *ja, MKL_INT *ia, MKL_Complex8 *b, MKL_INT *jb, MKL_INT *ib, MKL_Complex8 *c, MKL_INT *ldc);
void mkl_ccsradd(char *transa, MKL_INT *job, MKL_INT *sort, MKL_INT *m, MKL_INT *n, MKL_Complex8 *a, MKL_INT *ja, MKL_INT *ia, MKL_Complex8 *beta, MKL_Complex8 *b, MKL_INT *jb, MKL_INT *ib, MKL_Complex8 *c, MKL_INT *jc, MKL_INT *ic, MKL_INT *nnzmax, MKL_INT *ierr);

void mkl_zcsrmultcsr(char *transa, MKL_INT *job, MKL_INT *sort, MKL_INT *m, MKL_INT *n, MKL_INT *k, MKL_Complex16 *a, MKL_INT *ja, MKL_INT *ia, MKL_Complex16 *b, MKL_INT *jb, MKL_INT *ib, MKL_Complex16 *c, MKL_INT *jc, MKL_INT *ic, MKL_INT *nnzmax, MKL_INT *ierr);
void mkl_zcsrmultd(char *transa,  MKL_INT *m, MKL_INT *n, MKL_INT *k, MKL_Complex16 *a, MKL_INT *ja, MKL_INT *ia, MKL_Complex16 *b, MKL_INT *jb, MKL_INT *ib, MKL_Complex16 *c, MKL_INT *ldc);
void mkl_zcsradd(char *transa, MKL_INT *job, MKL_INT *sort, MKL_INT *m, MKL_INT *n, MKL_Complex16 *a, MKL_INT *ja, MKL_INT *ia, MKL_Complex16 *beta, MKL_Complex16 *b, MKL_INT *jb, MKL_INT *ib, MKL_Complex16 *c, MKL_INT *jc, MKL_INT *ic, MKL_INT *nnzmax, MKL_INT *ierr);
