...
_Mkl_Api(_INTEGER_t,dss_create_,(_MKL_DSS_HANDLE_t *,
	 _INTEGER_t const *))
_Mkl_Api(_INTEGER_t,dss_define_structure_,(_MKL_DSS_HANDLE_t *,
	 _INTEGER_t const *, _INTEGER_t const *, _INTEGER_t const *,
	 _INTEGER_t const *, _INTEGER_t const *, _INTEGER_t const *))
_Mkl_Api( _INTEGER_t,dss_reorder_,(_MKL_DSS_HANDLE_t *, _INTEGER_t const *,
	 _INTEGER_t const *))
_Mkl_Api(_INTEGER_t,dss_factor_real_,(_MKL_DSS_HANDLE_t *,
	 _INTEGER_t const *, void const *))
_Mkl_Api(_INTEGER_t,dss_factor_complex_,(_MKL_DSS_HANDLE_t *,
	 _INTEGER_t const *, void const *))
_Mkl_Api(_INTEGER_t,dss_solve_real_,(_MKL_DSS_HANDLE_t *,
	 _INTEGER_t const *, void const *, _INTEGER_t const *,
	 void *))
_Mkl_Api(_INTEGER_t,dss_solve_complex_,(_MKL_DSS_HANDLE_t *,
	 _INTEGER_t const *, void const *, _INTEGER_t const *,
	 void *))
_Mkl_Api( _INTEGER_t,dss_statistics_,( _MKL_DSS_HANDLE_t *, _INTEGER_t const *,
	 _CHARACTER_STR_t const *, _DOUBLE_PRECISION_t *))
_Mkl_Api(_INTEGER_t,dss_delete_,(_MKL_DSS_HANDLE_t const *,
	 _INTEGER_t const *))
