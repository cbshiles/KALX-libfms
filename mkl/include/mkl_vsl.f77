...
!  This header file is obsolete. Use mkl_vsl.f90 instead.
!--
...
!++
! BEGINNING OF DEPRECATED SECTION
!--
!  RNG errors (-1000..-1999)
!  brng errors
...
! BOXMULLER2      Box-Muller 2 algorithm based method
      ...
      PARAMETER (VSL_METHOD_SLOGNORMAL_ICDF = 1)
      PARAMETER (VSL_METHOD_DLOGNORMAL_ICDF = 1)
...
!  - FAST  - estimates are computed for prices of one or two passes of the
