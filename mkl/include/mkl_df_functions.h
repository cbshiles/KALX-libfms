...
/* Editor to modify a pointer in Data Fitting task */
...
/* Editor to modify a value in Data Fitting task */
_Mkl_Api(int,dfiEditVal,(DFTaskPtr  , const MKL_INT  , const MKL_INT  ))
_mkl_api(int,dfieditval,(DFTaskPtr *, const MKL_INT *, const MKL_INT *))
_MKL_API(int,DFIEDITVAL,(DFTaskPtr *, const MKL_INT *, const MKL_INT *))

/* Editor to modify the data for breakpoints, interpolation splines,
   dependent variable, spline coefficients */
