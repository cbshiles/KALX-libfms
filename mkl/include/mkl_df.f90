...
!  Editor to modify an array in the task
      INTERFACE
...
!  Editor to modify a value in the task
      INTERFACE
...
!  Editor to modify the data for functions or spline coefficients
      INTERFACE
         INTEGER FUNCTION dfseditidxptr(task,type,idx,ptr)
               USE MKL_DF_TYPE
            TYPE(DF_TASK)                        :: task
      ...
      INTERFACE
         INTEGER FUNCTION dfdeditidxptr(task,type,idx,ptr)
               USE MKL_DF_TYPE
            TYPE(DF_TASK)                        :: task
            INTEGER,INTENT(IN)                   :: type
            INTEGER,INTENT(IN)                   :: idx
...
!  Editor to modify parameters of Piece-wise Polynomial (PP) spline
      INTERFACE
