...
static AddInX xai_option_bms_value(
	...
	.Arg(XLL_DOUBLEX,_T("Interest Rate"),_T("is the interest rate."))
	.Arg(XLL_DOUBLEX, _T("Stock Price"), _T("is the underlying stock price."))
	...
	.Category(CATEGORY)
	.FunctionHelp(_T("Return 5 column array of BMS option value, delta, gamma, vega, and theta."))
);
